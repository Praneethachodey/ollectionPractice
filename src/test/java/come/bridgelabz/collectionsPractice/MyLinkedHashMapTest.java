...
public class MyLinkedHashMapTest {
	...
	@Test
	public void givenASentenceWordsAreAddedToListShouldReturnParanoidFrequency() {
		...
		Assert.assertSame(3, frequency);
	}
	
	@Test
	public void givenASentenceWordsAreAddedToListShouldDeleteAvoidable() {
		String sentence = "Paranoids are not paranoid because they are paranoid but because they keep putting themselves deliberately into paranoid avoidable situation";
		MyLinkedHashMap<String, Integer> myLinkedHashMap = new MyLinkedHashMap<>();
		String[] words = sentence.toLowerCase().split(" ");
		for (String word : words) {
		...
		Assert.assertSame(null, frequency);
	}
}
